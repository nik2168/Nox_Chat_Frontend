...
const ChatNew = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar - Chat List */}
      <div className="hidden lg:block w-[28rem] border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 flex-shrink-0 overflow-hidden">
        <Sidebar />
      </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {chatid ? (
          <ChatView chatId={chatid} onBack={() => navigate("/chat")} />
        ) : (
